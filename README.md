...
Projeto desenvolvido como requisito parcial para conclusão do módulo de Fundamentos do Desenvolvimento Web do curso de Desenvolvimento Web da Trybe. Neste projeto, são implementadas várias funções em JavaScript, utilizando as funcionalidades do ES6, tais como: arrow functions, template literals, spread operator, parâmetro rest, object destructuring, entre outras. São utilizadas também as _Higher Order Functions_. O objetivo é atender aos requisitos propostos, descritos em detalhes a seguir, e garantir que todas as funções criadas passem nos testes unitários.
...
- Produção de código legível, conciso e expressivo utilizando as novas funcionalidades do ES6
- Utilização das _Higher Order Functions_ para manipular e criar arrays
- Escolha da _Higher Order Function_ mais adequada para a obtenção de um resultado esperado
- Validação de aprendizado sobre como usar de forma conjunta as _Higher Order Functions_
- Interpretação de testes unitários e entrega de soluções que atendam a eles
